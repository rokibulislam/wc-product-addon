...
use PRAEF\Templates\Template_Blank;
...
class TemplateManager {
	...
	private function register_templates() {
		...
		$this->templates = apply_filters( 'prafe_form_templates', $templates );
	}
	...
	public function get_field_groups() {
		$before_custom_templates = apply_filters( 'prafe_form_templates_section_before', array() );
		$groups                  = array_merge( $before_custom_templates, $this->get_custom_templates() );
		$groups                  = array_merge( $groups, $this->get_others_templates() );
		$after_custom_templates  = apply_filters( 'prafe_form_templates_section_after', array() );
	...
	public function create( $name ) {
		...
		$form_id = product_addon_extra_field()->forms->create( $template->get_title(), $template->get_form_fields() );
